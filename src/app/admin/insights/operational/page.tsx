...
import { TrendingUp, Users, PlayCircle, ChevronRight, HardHat } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="rounded-none border-accent/5 bg-white p-10 space-y-8 shadow-xl">
          <div className="flex items-center gap-4">
            <HardHat className="h-5 w-5 text-accent/40" />
            <h4 className="text-[12px] font-bold uppercase tracking-[0.3em]">Trade Registry Control</h4>
          </div>
          <p className="text-[11px] font-light italic text-muted-foreground uppercase tracking-widest">Manage partner matrix, integrity scores, and trade certifications.</p>
          <Button asChild variant="outline" className="w-full rounded-none h-14 border-accent/10 text-accent text-[10px] font-bold uppercase tracking-widest flex gap-3 hover:bg-accent hover:text-white transition-all">
            <Link href="/admin/hr">Open Network Matrix <ChevronRight className="h-4 w-4" /></Link>
          </Button>
        </Card>

        <Card className="rounded-none border-accent/5 bg-white p-10 space-y-8 shadow-xl">
          <div className="flex items-center gap-4">
            <PlayCircle className="h-5 w-5 text-accent/40" />
            <h4 className="text-[12px] font-bold uppercase tracking-[0.3em]">Site Protocol Monitor</h4>
          </div>
          <p className="text-[11px] font-light italic text-muted-foreground uppercase tracking-widest">Live monitoring of architectural synchronization and site velocity.</p>
          <Button asChild variant="outline" className="w-full rounded-none h-14 border-accent/10 text-accent text-[10px] font-bold uppercase tracking-widest flex gap-3 hover:bg-accent hover:text-white transition-all">
            <Link href="/admin/operations/implementation">Live Implementation <ChevronRight className="h-4 w-4" /></Link>
          </Button>
        </Card>
      </div>
    </div>
